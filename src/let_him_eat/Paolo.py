...
WALLS = [
    ...
    # Settore 2
    pygame.Rect(652, 210, 136, 35),
    pygame.Rect(706, 173, 34, 35),
    ...
    pygame.Rect(356, 465, 31, 110),
    pygame.Rect(255, 548, 35, 115),
    pygame.Rect(260, 382, 31, 115),
    pygame.Rect(460, 464, 27, 115),
    pygame.Rect(500, 464, 89, 31),
    pygame.Rect(105, 717, 81, 31),
    pygame.Rect(255, 717, 81, 31),
    pygame.Rect(360, 630, 130, 31),
    ...
    pygame.Rect(1105, 462, 31, 119),
    pygame.Rect(1155, 550, 31, 116),
    pygame.Rect(1105, 717, 81, 29),
    pygame.Rect(1255, 717, 81, 29),
    pygame.Rect(1255, 590, 81, 77),
